 ...
 * Clase para crear un árbol binario de busqueda.
 */
public class ABB{
    ...
    public void insertarNodo(int valor, Nodo nodoA){
        if (valor <= nodoA.name) {
            if (nodoA.izquierdo == null){
                System.out.println("Insertando hijo izquierdo de: "  + nodoA.name + ": " + valor);
            ...
            if (valor > nodoA.name) {
                if (nodoA.derecho == null){
                    System.out.println("Insert hijo derecho de: " + nodoA.name + ": " + valor);
    ...
    public void eliminarPredecesor(int x, Nodo nodoA) {
        if (nodoA == null) {
            ...
            eliminarPredecesor(mayor.name, nodoA.izquierdo); // Llama recursivamente al método eliminarPredecesor para eliminar el nodo mayor en el subárbol izquierdo
        } else {
            if (nodoA.izquierdo == null) {
